"""
Validate DRAEM model on enhanced synthetic data with shockwave/vibration patterns.
...
def main() -> None:
    ...
    import tempfile
    print("DRAEM Validation on Enhanced Synthetic Data")
    print("=" * 60)
